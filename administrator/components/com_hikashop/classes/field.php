...
<?php
	...
	function getFieldName($field){
		...
		return '<label for="'.$this->prefix.$field->field_namekey.$this->suffix.'" class="col-sm-4 control-label">'.$this->trans($field->field_realname).'</label>';
	}
